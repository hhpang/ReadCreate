...
public class DropPanelWrapper {
	...
	//id identificador del panel
	private int ID;
	//nombre del lugar visitado al que corresponde
	private String title = "";
	
	//nombre archivo de audio
    ...
    {
        if (drawLayer == null)
        	drawLayer = Bitmap.createBitmap(989, 670, Bitmap.Config.ARGB_8888);
    	return drawLayer;
    }
	...
	public void setRecorded(boolean recorded, String filename) {
